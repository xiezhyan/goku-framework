...
import top.zopx.goku.framework.socket.recognizer.MsgBusRecognizer;
...
public abstract class BaseCmdHandlerFactory {
     ...
     */
    public void tryInit() {
        MsgBusRecognizer.recognizerToCmdAndHandlerByPackage(getScanPackage());
    }
    ...
    public ICmdHandler<? extends GeneratedMessageV3> create(Class<?> cmdClazz) {
        ...
        return MsgBusRecognizer.get(cmdClazz);
    }
}
