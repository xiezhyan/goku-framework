...
import top.zopx.goku.framework.socket.netty.handle.ICmdHandle;
...
public final class MainThreadPoolExecutor {
     ...
     * 消息处理类工厂
     */
    private final ICmdHandle factory;

    public MainThreadPoolExecutor(String threadName, ICmdHandle factory) {
    ...
    public void process(BaseCmdHandleContext ctx, GeneratedMessageV3 cmdMsg) {
        ...
        this.process(() -> {
            ...
            final ICmdContextHandle<? extends BaseCmdHandleContext, ? extends GeneratedMessageV3> cmdHandler =
