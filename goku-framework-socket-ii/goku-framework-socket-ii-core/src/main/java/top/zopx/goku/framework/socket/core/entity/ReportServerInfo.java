 ...
 * @date 2023/8/20 09:28
 */
public class ReportServerInfo implements Serializable {
    /**
     * 服务ID
     */
    ...
    public void setServerJobTypeSet(Set<String> serverJobTypeSet) {
        this.serverJobTypeSet = serverJobTypeSet;
    }
