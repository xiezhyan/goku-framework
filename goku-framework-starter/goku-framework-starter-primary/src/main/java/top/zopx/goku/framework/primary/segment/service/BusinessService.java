package top.zopx.goku.framework.primary.segment.service;

import org.springframework.dao.EmptyResultDataAccessException;
import org.springframework.jdbc.core.JdbcTemplate;
import org.springframework.jdbc.core.PreparedStatementCreator;
import top.zopx.goku.framework.primary.core.entity.Business;
import top.zopx.goku.framework.primary.core.service.IBusinessService;
import top.zopx.goku.framework.primary.segment.entity.TbSegment;
import top.zopx.goku.framework.primary.segment.mapper.ResultSetToRowMapperForUniqueIdBus;
...
public class BusinessService implements IBusinessService {
    ...
    public synchronized Business getBusinessByKey(String key, int pullSize) {
        ...
        if (0 == update) {
            throw new BusException(MessageFormat.format("业务ID操作出现异常, 标识key={0}", key));
        }
