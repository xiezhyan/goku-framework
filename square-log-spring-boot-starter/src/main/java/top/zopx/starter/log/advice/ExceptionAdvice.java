...
public class ExceptionAdvice {
    ...
    public R<String> handleException(Exception e) {
        ...
        publish(e);
        return R.failure(e.getMessage(), BusCode.RESULT_ERROR);
    }
    ...
    public R<String> handleValidationException(MethodArgumentNotValidException e) {
        ...
        publish(e);
        return R.failure(e.getBindingResult().getAllErrors().get(0).getDefaultMessage(), BusCode.PARAM_VALIDATE_ERROR);
    ...
    public R<String> handleValidationException(ConstraintViolationException e) {
        ...
        publish(e);
        return R.failure(e.getMessage(), BusCode.PARAM_VALIDATE_ERROR);
    }
    ...
    public R<String> handleValidationException(BindException e) {
        ...
        publish(e);
        return R.failure(FJsonUtil.INSTANCE.toJson(errorMap), BusCode.PARAM_VALIDATE_ERROR);
    }
